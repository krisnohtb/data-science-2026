...
Selanjutnya saya mempelajari unsupervised learning melalui algoritma K-Means dan Hierarchical Clustering, termasuk penggunaan Metode Elbow untuk menentukan jumlah cluster optimal (Pertemuan 11). Saya juga mempelajari konsep asosiasi data melalui Algoritma Apriori (Market Basket Analysis) serta dasar sistem rekomendasi, baik Collaborative Filtering maupun Content-Based Filtering (Pertemuan 12). Terakhir, saya mendapat pengantar Deep Learning melalui konsep dasar Artificial Neural Network, serta pemrosesan teks sederhana menggunakan TF-IDF untuk analisis sentimen (Pertemuan 13).

Melalui keseluruhan praktikum ini, saya memahami bahwa Data Science mencakup rangkaian proses yang luas — mulai dari memahami dan membersihkan data, menganalisis pola, membangun model prediktif maupun deskriptif, hingga menginterpretasikan hasil model secara kritis sesuai konteks masalahnya. Keterbatasan yang saya rasakan adalah masih perlu memperdalam intuisi dalam memilih algoritma dan metrik evaluasi yang tepat untuk berbagai jenis dataset, khususnya pada kasus data yang tidak seimbang serta pada penerapan deep learning yang lebih kompleks.
